import numpy as np
import pytest
from pysarpro import color, data, img_as_float
from pysarpro._shared.testing import assert_array_almost_equal, assert_equal
from pysarpro.filters import gaussian, threshold_local
from pysarpro.util.apply_parallel import apply_parallel
